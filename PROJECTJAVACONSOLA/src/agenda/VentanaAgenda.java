...
public class VentanaAgenda extends javax.swing.JFrame {
    ...
    public void cargarBaseDatos() {
       personas_al.add(new Persona("111111111A","Luis","Roncal","Av. Ejercito 123","678939345","10/10/2000"));
       personas_al.add(new Persona("222222222B","Miguel","Lescano","Av. Orbegoso 456","688339245","01/09/1998"));
